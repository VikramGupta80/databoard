...
import 'package:databoard/model/article.dart';
import 'package:databoard/service/article_bloc_provider.dart';
import 'package:databoard/ui/about_page.dart';
import 'package:databoard/ui/sources_page.dart';
          ...
          appBar: AppBar(
            leading: widget.flipBack != null
                ...
                : Padding(
                    ...
                    child: Image.asset(
                      'assets/images/databoard_logo.png',
                    ),
                  ),
            title: Text(
